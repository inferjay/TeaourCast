...
public class TFMNewsletterActivity extends TFMBaseActivity implements TextWatcher, TFMSubscibeNewsLetterService.OnSubscibeNewsLetterListener{
    ...
    public void onSubscibeSuccess(String success) {
        ...
        if (!TextUtils.isEmpty(success)) {
            ...
            if (success.contains("Almost finished")) {
                ...
                success = String.format(getString(R.string.text_msg_newslette_already_subscibed), mSubscibeEmialEditText.getText().toString());
        ...
        if (!TextUtils.isEmpty(success)) {
            ...
            mSubscibeMsg.setHtmlFromString(success, false);
        }
    }
